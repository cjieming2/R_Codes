setwd('C:/Users/Jieming/Documents/thesis/lynne_work/motifVar/tpr/old')

## relative entropy data
sorted.rel.ent = read.table('1KG.snps.nonmono.smartDomain2gPos.TPR.34aa.sorted.enrich', header=T, stringsAsFactors = F)
