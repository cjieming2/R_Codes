...
pca.plot <- function (x, y, xlab, ylab, main, col, categories, highlightIdx=0, lweight=40, rweight=10, ...)
{
	...
	if(highlightIdx == 0)
	{
		...
		#id6 = which(data$population.abbreviation == "23andme_aw") ###
...
#baseFileName = "2804samples-31007snps-hhs-jnov-AWJC23andme"		#Base file name of the .PCA and .EVAL file from fpca
baseFileName = "jconly-NoJnov-1422sa-31007snps"
title = baseFileName	#Title of plot
annotFilename="jconly-NoJnov.sa" ##Annotation File
...
#colors <- c("black","black","red","red","purple","green","yellow","orange","greenyellow","blue","cyan","lightblue","brown","magenta","lightgoldenrod4","darkgreen","grey")
colors <- c("black","red","red","purple","green","yellow","orange","greenyellow","blue","cyan","brown","magenta","lightgoldenrod4","darkgreen","grey")
...
#poplegend <- c("23andme","CEU","CHB","JPT","YRI","HGDP-Africa","HGDP-America","HGDP-Europe","HGDP-Middle-East","HGDP-Oceania","HGDP-CentralSouth-Asia","HGDP-East-Asia","PASNP-CentralSouth-Asia","PASNP-East-Asia")
