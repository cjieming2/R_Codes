## This is the actual betabinomial calculation requires the overdispersion parameter and counts.txt
## If you have the overdispersion parameter, you can just run it with the counts.txt and a file 
## with the overdispersion parameter in the following format:
##  "b.choice"      "sse"
##  0.02421875      0.00198985592170199
