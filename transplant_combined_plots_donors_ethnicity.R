setwd("/Users/jiemingchen/Documents/transplantation/a_donor/combined")
...
idata = read.table("combined_emr_immport_unos-year-1987-2010.txt", header = T, sep = "\t")
a.d = idata
...
plegend = theme(legend.title = element_text(face = "bold", size = 15), legend.text = element_text(size = 14))
pmain + phisto + pfacet + plabels + pticks + paxes + ptitle + plegend + scale_fill_brewer(palette = "Set1")
# ggsave("plot_combined_immport_emr_unos-jun2016_age_ethnicity_kidney_donors_bars.pdf", device = "pdf")
...
plegend = theme(legend.title = element_text(face = "bold", size = 15), legend.text = element_text(size = 14))
pmain + phisto + pfacet + plabels + pticks + paxes + ptitle + plegend + scale_fill_brewer(palette = "Set1")
# ggsave("unos-ehr-immport-proportion-ethnicity-forsymp.pdf", device = "pdf")
# ggsave("plot_combined_immport_emr_unos-jun2016_age_ethnicity_kidney_donors_bars-1987-2010.pdf", device = "pdf")
...
plegend = theme(legend.title = element_text(face = "bold", size = 15), legend.text = element_text(size = 14))
pmain + phisto + pfacet + plabels + pticks + paxes + ptitle + plegend + scale_fill_brewer(palette = "Set1")
# ggsave("plot_combined_immport_emr_unos-jun2016_sex_ethnicity_kidney_donors_bars.pdf", device = "pdf")
...
plegend = theme(legend.title = element_text(face = "bold", size = 15), legend.text = element_text(size = 14))
pmain + phisto + pfacet + plabels + pticks + paxes + ptitle + plegend + scale_fill_brewer(palette = "Set1")
# ggsave("plot_combined_immport_emr_unos-jun2016_ethnicity_sex_kidney_donors_bars-all-1987-2010.pdf", device = "pdf")
...
plegend = theme(legend.title = element_text(face = "bold", size = 15), legend.text = element_text(size = 14))
pmain + phisto + pfacet + plabels + pticks + paxes + ptitle + plegend + scale_fill_brewer(palette = "Set1")
ggsave("plot_combined_immport_emr_unos-jun2016_ethnicity_sex_kidney_donors_bars-noCaucasians-1987-2010.pdf", device = "pdf")
