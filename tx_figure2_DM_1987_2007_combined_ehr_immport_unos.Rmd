...
## UNOS - 1999-2016 (prior to 1999 removed)
## ImmPort - 1963 - 2007
## filtering out UNOS individuals from 1987 to 1998 and 2008 to 2016
## filtering out ImmPort individuals with NA and from 1963 to 1998
UNOS_notIn1999To2007 <- read.table("/Users/chenj220/Documents/ucsf/transplantation/a_donor/unos/unos-LIVING_DONOR_DATA_DM_race_organ_relation-kidney-us-80606-not-year-1999-2007.txt", header = T, sep = "\t") ## 80606 subjs
UNOS_notIn1999To2007$DONOR_ID <- as.character(UNOS_notIn1999To2007$DONOR_ID)
idata <- idata %>% filter(!idata$Patient_ID %in% UNOS_notIn1999To2007$DONOR_ID)
## the minused numbers dont match probably because those without sex and ehtincitiy were already removed previously 

ImmPort_notIn1999To2007 <- 
  read.table("/Users/chenj220/Documents/ucsf/transplantation/a_donor/immport/finals.iTx/final.iTx.DM.v16_NA_between1963and1998.txt", header = T, sep = "\t") ## 7169 subjects
idata <- idata %>% filter(!idata$Patient_ID %in% ImmPort_notIn1999To2007$Sub_Org_Accession)

idata <- idata %>%
  filter(Data_Source != "UCSF_EMR")
...
## ggsave("/Users/chenj220/Documents/ucsf/transplantation/manuscript/submission/1-jamaNetworkOpen/submission2/FigureA1_gender_trends_1999-2007.pdf", device = "pdf")
...
# ggsave("/Users/chenj220/Documents/ucsf/transplantation/manuscript/submission/1-jamaNetworkOpen/submission2/FigureA2_racial_trends_1999-2007.pdf", device = "pdf", width = 10, height = 5)
