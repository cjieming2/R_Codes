...
setwd("C:/Users/JM/thesis/mark_work/23andme")
...
pca.plot <- function (x, y, xlab, ylab, main, col, categories, highlightIdx=0, lweight=40, rweight=10, ...)
{
	...
	if(highlightIdx == 0)
	{
		...
		id6 = which(data$population.abbreviation == "American")
		...
		points(x[id6], y[id6], pch=21, col="red", bg="black",cex=1.75)
...
baseFileName = "1382samples-52821snps-aw23andme-jnov-final"		#Base file name of the .PCA and .EVAL file from fpca
title = baseFileName	#Title of plot
annotFilename="1382samples-jnovembre.sa" ##Annotation File
