...
filename1 = "proportions_AS_rare_lt005_0bins_noCDS.txt";
...
ordered3 <- c(data1["chipseq.nonpeaks","V4"],data1["chipseq.nonhets","V4"],data1["chipseq.hets","V4"],
              data1["rnaseq.nonpeaks","V4"],data1["rnaseq.nonhets","V4"],data1["rnaseq.hets","V4"])

ordered2 <- c(data1["chipseq.nonhets","V4"],data1["chipseq.hets","V4"],
              data1["rnaseq.nonhets","V4"],data1["rnaseq.hets","V4"])
...
barsy2=barplot(ordered2,xlab="Fraction of rare SNPs in a Personal Genome", names.arg=c('r.nas','r.as','c.nas','c.as'), horiz=TRUE,
              cex.lab=1.5,cex.axis=1.5,cex.names=1.5, col=colors2,xpd=FALSE, xlim=c(0.01,0.09), width=0.5,
              las=1, # set hori y axis label
