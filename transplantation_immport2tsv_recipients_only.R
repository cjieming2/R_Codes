setwd("/Users/jiemingchen/Documents/transplantation/a_recipient/immport")
...
recip_kidney_ids=c('SDY131','SDY132','SDY133','SDY134','SDY352','SDY354',
                   'SDY355','SDY356','SDY357','SDY358','SDY479','SDY546',
                   'SDY557','SDY668','SDY670','SDY671','SDY674','SDY689')
...
## recips ####
data.recip = read.table("immport_DR19_DM_immport2tsv_recip_subjects_21studies.mergeDup.kidney.tsv", header = T, sep = "\t")
a.d=data.recip[data.recip$AGEU != "Not_Specified",]
...
# savePlot("immport_DR19_DM_age_sex_organ_studies_races_combined_histogram_kidney_recips.png", type = "png")
...
# savePlot("immport_DR19_DM_race_ethnicity_study_gender_combined_histogram_kidney_recips.png", type = "png")
