...
#baseFileName = "1kg.uniq.sorted.predicted_genotypes_0.2000_0.4000.beddat"		#Base file name of the .PCA and .EVAL file from fpca
...
for (i in filenames)
{
  ...
  png(filename=paste(baseFileName, ".pairs.png"))
