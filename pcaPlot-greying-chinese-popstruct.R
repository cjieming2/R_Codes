...
sample_annotation <- read.table("7318samples-chinese-jpt-chb-pop-hapmap2r23.sa", header=T, sep = "\t")
...
### Read data
infile <- "1338samples-52379snps-db126-1293chinese+45chb-hapmap2r23-snpset1.pca";
...
varInfo <- read.table("1338samples-52379snps-db126-1293chinese+45chb-hapmap2r23-snpset1.eval", header=TRUE, sep="\t")
