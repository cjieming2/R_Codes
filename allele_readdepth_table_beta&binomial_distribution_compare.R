setwd("C:/Users/Jieming/Documents/thesis/mark_work/allele_specificity/read depth")
library(VGAM)
...
################################## MAIN #######################################
### set parameters
filename = "counts.peaks.min6.allelicRatio.mod.auto.NA12878.BRCA1.txt"
# filename = "counts.min6.allelicRatio.mod.auto.NA12878.rnaseq.txt"
# filename = "counts.peaks.min6.allelicRatio.mod.auto.NA12891.RPB2.txt"
data = read.table(filename, header=T, stringsAsFactors=F)

dir.create("betabinomial")
setwd("C:/Users/Jieming/Documents/thesis/mark_work/allele_specificity/read depth/betabinomial")
