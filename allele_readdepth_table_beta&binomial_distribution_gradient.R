## Run this script to calculate the betabinomial overdispersion of the dataset
## This script requires file with 2 columns (counts.txt or not): 
## total        - #total number of reads (cA+cC+cG+cT)
## allelicRatio - #reference reads/#total
## 
...
filename = "counts.peaks.min6.allelicRatio.mod.auto.NA11830.PU1.txt"
data = read.table(filename, header=T, stringsAsFactors=F)

dir.create("betabinomial")
setwd("C:/Users/Jieming/Documents/thesis/mark_work/allele_specificity/overdispersion_read depth/betabinomial")
